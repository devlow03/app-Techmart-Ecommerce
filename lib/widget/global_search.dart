...
Future<T?> showSearch<T>({
  ...
  required GlobalSearch<T> delegate,
  String? query = '',
...
enum _SearchBody {
  ...
  ///
  /// The suggested queries are generated by [GlobalSearch.buildSuggestions].
  suggestions,

  /// Search results are currently shown in the body.
  ///
  /// The search results are generated by [GlobalSearch.buildResults].
  results,
}
...
class _SearchPageRoute<T> extends PageRoute<T> {
  _SearchPageRoute({
    ...
    'The ${delegate.runtimeType} instance is currently used by another active '
        'search. Please close that search by calling close() on the GlobalSearch '
        'before opening another search with the same delegate instance.',
    );
    delegate._route = this;
  }

  final GlobalSearch<T> delegate;
